...
export default function AboutMe() {
  return (
    <div className="lg:grid lg:grid-cols-2 lg:justify-center lg:content-center lg:pl-20 gap-8 w-auto">
      <div className="h-[90vh] lg:h-auto flex flex-col justify-center items-center lg:items-start gap-2">
        <h2 className="overflow-hidden whitespace-nowrap text-4xl xl:text-6xl font-bold text-left">
          Hello World!
        </h2>
        <h2 className="overflow-hidden whitespace-nowrap text-4xl xl:text-6xl font-bold text-left">
          I am
